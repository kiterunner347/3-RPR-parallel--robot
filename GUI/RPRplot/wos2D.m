...
filledCircle(ax1,Ori1,r,N,color(1));text(Ori1(1)+70,Ori1(2),'F1','horiz','center');
filledCircle(ax1,Ori2,r,N,color(2));text(Ori2(1)+70,Ori2(2),'F2','horiz','center');
filledCircle(ax1,Ori3,r,N,color(3));text(Ori3(1)+70,Ori3(2),'F3','horiz','center');
