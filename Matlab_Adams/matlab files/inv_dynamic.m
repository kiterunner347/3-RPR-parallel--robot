%function F = inv_dynamic(q,qd,qdd)
...
yc4 = (r1-lc(4))*ys/r1;
yc5 = (r2-lc(5))*ys/r2;
yc6 = (r3-lc(4))*(ys-a3*sin(phis))/r3;
yc7 = ys-a3*sin(phis)+(a3-lc(7))*sin(phis);
...
Jacob = [Dr1Dx Dr2Dx Dr3Dx;Dr1Dy Dr2Dy Dr3Dy;Dr1Dphi Dr2Dphi Dr3Dphi];
